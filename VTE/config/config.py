...
_C.data_loader.video_data_path = ''
_C.data_loader.image_data_path = ''
_C.data_loader.seed = 0
_C.data_loader.scale = 16
_C.data_loader.batch_size = 32                    # input batch size for training (default: 32)
_C.data_loader.video_batch_size = 32
...
# LACP
_C.lacp = CN()
_C.lacp.len_features = 2048
_C.lacp.r_act = 2
_C.lacp.batch_size = 32                           # LACP fc batch size
# _C.lacp.lr = [0.0001]*30000
_C.lacp.search_freq = 100
_C.lacp.save_freq = 100
_C.lacp.eval_freq = 100
_C.lacp.class_thresh = 0.5
_C.lacp.scale = 16
_C.lacp.budget = 25
_C.lacp.lambdas = [1,0.5,1,1,1] 
_C.lacp.output_path = ''
_C.lacp.model_path = ''
_C.lacp.log_path = ''

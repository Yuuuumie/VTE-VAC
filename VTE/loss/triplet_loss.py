...
def pairwise_distance_torch(embeddings):
    ...
    # print('c1', c1, c1.size())
    # print('c2', c2, c2.size())
    # print('c12', pairwise_distances_squared, pairwise_distances_squared.size())

    c12 = c1 - c2
    pairwise_distances_squared = torch.pow(torch.mul(torch.sigmoid(c12), 2)-1, 2)

    # print('c12_s', c12, c12.size())
    # quit()
...
class TripletLoss(nn.Module):
    ...
    def forward(self, input, target, **kwargs):
        return TripletSemiHardLoss(target, input)
